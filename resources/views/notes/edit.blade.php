    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-between">
                <h1 class="text-white">Edit a Note</h1>
            ...
            <form action="{{ route('notes.update',$note)}}" class="mt-6 space-y-6">
                @csrf
                @method("PATCH")
                <div>
                ...
                <div>
                    ...
                    <x-textarea name='body' id="body" class="mt-1 block w-full">{{old('body',$note->body)}}</x-textarea>
